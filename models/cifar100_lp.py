...
# AlexNet
@register_model
def lp_alexnet_cifar100(pretrained=False, **kwargs):
...
@register_model
def lp_resnet34_cifar100(pretrained=False, **kwargs):
    model = models.resnet34(pretrained=pretrained, num_classes=100)
    model.conv1 = nn.Conv2d(3, 64, kernel_size=(3, 3), stride=(1, 1), padding=(1, 1), bias=False) # for cifar shape 32x32
    return LpConvert(model, log2p=4)

@register_model
def lp_resnet50_cifar100(pretrained=False, **kwargs):
    model = models.resnet50(pretrained=pretrained, num_classes=100)
    model.conv1 = nn.Conv2d(3, 64, kernel_size=(3, 3), stride=(1, 1), padding=(1, 1), bias=False) # for cifar shape 32x32
    return LpConvert(model, log2p=4)

@register_model
def lp_resnet101_cifar100(pretrained=False, **kwargs):
    model = models.resnet101(pretrained=pretrained, num_classes=100)
    model.conv1 = nn.Conv2d(3, 64, kernel_size=(3, 3), stride=(1, 1), padding=(1, 1), bias=False) # for cifar shape 32x32
    return LpConvert(model, log2p=4)

@register_model
def lp_resnet152_cifar100(pretrained=False, **kwargs):
...
# DenseNet
@register_model
def lp_densenet121_cifar100(pretrained=False, **kwargs):
...
@register_model
def lp_densenet161_cifar100(pretrained=False, **kwargs):
...
@register_model
def lp_densenet169_cifar100(pretrained=False, **kwargs):
    model = models.densenet169(pretrained=pretrained, num_classes=100)
    model.features.conv0 = nn.Conv2d(3, 64, kernel_size=(3, 3), stride=(1, 1), padding=(1, 1), bias=False) # for cifar shape 32x32
    return LpConvert(model, log2p=4)

@register_model
def lp_densenet201_cifar100(pretrained=False, **kwargs):
...
# WideResNet
@register_model
def lp_wide_resnet50_2_cifar100(pretrained=False, **kwargs):
    model = models.wide_resnet50_2(pretrained=pretrained, num_classes=100)
    model.features.conv0 = nn.Conv2d(3, 64, kernel_size=(3, 3), stride=(1, 1), padding=(1, 1), bias=False) # for cifar shape 32x32
    return LpConvert(model, log2p=4)

@register_model
def lp_wide_resnet101_2_cifar100(pretrained=False, **kwargs):
...
# ResNeXt
@register_model
def lp_resnext50_32x4d_cifar100(pretrained=False, **kwargs):
    model = models.resnext50_32x4d(pretrained=pretrained, num_classes=100)
    model.conv1 = nn.Conv2d(3, 64, kernel_size=(3, 3), stride=(1, 1), padding=(1, 1), bias=False) 
    return LpConvert(model, log2p=4)

@register_model
def lp_resnext101_32x8d_cifar100(pretrained=False, **kwargs):
    model = models.resnext101_32x8d(pretrained=pretrained, num_classes=100)
    model.conv1 = nn.Conv2d(3, 64, kernel_size=(3, 3), stride=(1, 1), padding=(1, 1), bias=False) 
    return LpConvert(model, log2p=4)

@register_model
def lp_resnext101_64x4d_cifar100(pretrained=False, **kwargs):
...
# ConvNeXt
@register_model
def lp_convnext_base_cifar100(pretrained=False, **kwargs):
    model = models.convnext_base(pretrained=pretrained, num_classes=100)
    return LpConvert(model, log2p=4)

@register_model
def lp_convnext_large_cifar100(pretrained=False, **kwargs):
    model = models.convnext_large(pretrained=pretrained, num_classes=100)
    return LpConvert(model, log2p=4)

@register_model
def lp_convnext_small_cifar100(pretrained=False, **kwargs):
    model = models.convnext_small(pretrained=pretrained, num_classes=100)
    return LpConvert(model, log2p=4)

@register_model
def lp_convnext_tiny_cifar100(pretrained=False, **kwargs):
    model = models.convnext_tiny(pretrained=pretrained, num_classes=100)
    return LpConvert(model, log2p=4)

# ViT
@register_model
def lp_vit_s_cifar100(pretrained=False, **kwargs):
...
@register_model
def lp_vit_b_cifar100(pretrained=False, **kwargs):
    model = models.VisionTransformer(
        image_size=32,
        patch_size=4,
        num_layers=12,
...
@register_model
def lp_vit_l_cifar100(pretrained=False, **kwargs):
    model = models.VisionTransformer(
        image_size=32,
        patch_size=4,
        num_layers=24,
