...
# AlexNet
@register_model
def alexnet_cifar10(pretrained=False, **kwargs):
...
# VGG
@register_model
def vgg11_cifar10(pretrained=False, **kwargs):
    model = models.vgg11(pretrained=pretrained, num_classes=num_classes)
    return model

@register_model
def vgg13_cifar10(pretrained=False, **kwargs):
...
@register_model
def vgg19_bn_cifar10(pretrained=False, **kwargs):
...
@register_model
def resnet101_cifar10(pretrained=False, **kwargs):
    model = models.resnet101(pretrained=pretrained, num_classes=num_classes)
    model.conv1 = nn.Conv2d(3, 64, kernel_size=(3, 3), stride=(1, 1), padding=(1, 1), bias=False) # for cifar shape 32x32
    return model

@register_model
def resnet152_cifar10(pretrained=False, **kwargs):
...
@register_model
def densenet161_cifar10(pretrained=False, **kwargs):
...
@register_model
def densenet169_cifar10(pretrained=False, **kwargs):
    model = models.densenet169(pretrained=pretrained, num_classes=num_classes)
    model.features.conv0 = nn.Conv2d(3, 64, kernel_size=(3, 3), stride=(1, 1), padding=(1, 1), bias=False) # for cifar shape 32x32
    return model

@register_model
def densenet201_cifar10(pretrained=False, **kwargs):
...
# WideResNet
@register_model
def wide_resnet50_2_cifar10(pretrained=False, **kwargs):
    model = models.wide_resnet50_2(pretrained=pretrained, num_classes=num_classes)
    model.features.conv0 = nn.Conv2d(3, 64, kernel_size=(3, 3), stride=(1, 1), padding=(1, 1), bias=False) # for cifar shape 32x32
    return model

@register_model
def wide_resnet101_2_cifar10(pretrained=False, **kwargs):
...
# ResNeXt
@register_model
def resnext50_32x4d_cifar10(pretrained=False, **kwargs):
    model = models.resnext50_32x4d(pretrained=pretrained, num_classes=100)
    model.conv1 = nn.Conv2d(3, 64, kernel_size=(3, 3), stride=(1, 1), padding=(1, 1), bias=False) 
    return model

@register_model
def resnext101_32x8d_cifar10(pretrained=False, **kwargs):
    model = models.resnext101_32x8d(pretrained=pretrained, num_classes=100)
    model.conv1 = nn.Conv2d(3, 64, kernel_size=(3, 3), stride=(1, 1), padding=(1, 1), bias=False) 
    return model

@register_model
def resnext101_64x4d_cifar10(pretrained=False, **kwargs):
