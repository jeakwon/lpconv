...
if __name__ == "__main__":
    ...
    for dirpath in experiments.keys():
        ...
        save_dir = os.path.join(args.save_dir, exp_args.seed)
        benchmark(new_model, save_dir=save_dir, data_path=args.data_path, batch_size=args.batch_size, lr=args.lr, seed=exp_args.seed, verbose=args.verbose, debug=args.debug)
